...
\begin{comment}
\textbf{Security Axioms, Inc.} \hfill {Atlanta, GA}
\begin{innerlist}
\item[] Chief Engineer \hfill {Jan 2013 to present}\\
Research Intern \hfill {May 2012 to Dec 2012}\\
Research Intern \hfill {May 2011 to Aug 2011}\\
    \begin{innerlist}
    	\item Worked as a lead developer for \emph{CloudCapsule} project, a confidentiality protection solution on user's private data.
    	\item Designed hypervisor-based (Xen, Linux/KVM) wiping mechanism for desktop/laptop devices.
    	\item Developed iOS application based on isolation provided by application sandbox (released at the App Store).
        \item Developed ChatMate, a user-interface monitoring system for security on Android (will be released at Google Play Store).
    \end{innerlist}
\end{innerlist}
\medskip
\end{comment}
...
\vspace{-.1275in}
\begin{bibsection}
    \item {\bf Kargus: a Highly-scalable Software-based Intrusion
Detection System}\\
    {\small
    Muhammad Jamshed, Jihyung Lee, Sangwoo Moon, \textbf{Insu Yun}, Deokjin Kim, Sungryoul Lee, Yung Yi and KyoungSoo Park\\
    In proceedings of {\it The 19th ACM Conference on Computer and Communications Security} {\bf (\emph{CCS 12'})}, Raleigh, NC, USA, on Oct, 2012.
    }
...
\begin{innerlist}
%\item Hungry Hungry Hacker (H3) Hacking Competition \hfill Atlanta, GA\\
%1st Place of the contest \hfill Oct 2011\\
%3rd Place of the contest \hfill Oct 2010\\
...
%oCTF, 2nd Place of the contest (team disekt) \hfill Aug 2011\\
%oCTF, 2nd Place of the contest (team DDUCK)  \hfill Aug 2008\\
